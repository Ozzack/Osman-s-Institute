              ...
              <div className="space-y-4">
                <div className="flex items-start space-x-4">
                  ...
                  <div>
                    ...
                    <p className="text-gray-600">info@osmansinstitute.com</p>
                  </div>
                </div>
                <div className="flex items-start space-x-4">
            ...
            <div className="bg-gray-50 p-8 rounded-lg">
              ...
              <div className="space-y-4">
                <div>
                  ...
                  <p className="text-gray-600">Simply browse our courses, select the one you're interested in, and click the "Enroll Now" button.</p>
                </div>
                <div>
